...
def lstm_nn_location_model(shape_main, shape_aux):
    ...
    lstm_out = LSTM(1024, activation='sigmoid')(main_input)
...
model = lstm_nn_location_model(input_shape, input_shape_aux)
...
model.fit([features, locations], [labels, labels], epochs=50, batch_size=32, validation_split=0.1, verbose=2, class_weight={1: 1, 0:0.1})
